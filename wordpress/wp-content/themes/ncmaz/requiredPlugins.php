	...
	function ncmaz_theme_register_required_plugins()
	{
		...
		$plugins = [
            ...
            [
                ...
                'slug'         => 'wpgraphql-acf',
                'source'       => 'https://github.com/wp-graphql/wpgraphql-acf/archive/master.zip',
                'required'     => true,
                'version'    => '2.3.0'
            ],
		];
...
if (!function_exists('ncmazTheme_admin_notice_ncmaz_plugins_not_updated')) :
	...
	function ncmazTheme_admin_notice_ncmaz_plugins_not_updated()
	{
		...
		if ($isNcmazFrontendOk && $isNcmazCoreOk) {
			return;
		}
...
<div class="notice notice-error is-dismissible">
    ...
    <p style="color: chocolate;">
        <strong style="text-decoration: underline;">*Importance:</strong> You need to update <strong>ncmaz-core
            plugin</strong> & <strong>ncmaz-frontend plugin</strong> to work properly with this theme version.
        Otherwise, an unexpected error may occur.
    </p>
    <?php endif; ?>
    <p>
        Navigate to <strong>Appearance -> Install Plugin -> Active/Update</strong> the <strong>required</strong>
        plugins.
    </p>
</div>
<?php
